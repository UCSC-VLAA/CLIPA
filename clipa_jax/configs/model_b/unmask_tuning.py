...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=224, runlocal=False, batchsize=32768,  token_len=32, txt='bert_base', img='B/16',
 ...
 # input section include augmentation
  ...
  config.masked_init = "gs://lxh-jax-celt-eu-west4a/clip_jax_aug/flip_B32_32k_40_mask75_tok_text77_sin2d_lr8e/checkpoint.npz"
