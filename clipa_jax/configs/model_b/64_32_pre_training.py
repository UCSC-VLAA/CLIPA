...
def get_config(arg=None):
  ...
  arg = bvcc.parse_arg(
      arg,  res=64, runlocal=False, batchsize=32768,  token_len=32, txt='bert_base', img='B/16',
 ...
 # input section include augmentation
  ...
  config.total_steps = int(2497740800 // arg.batchsize)  # seen_samples // batchsize to get the number of steps
