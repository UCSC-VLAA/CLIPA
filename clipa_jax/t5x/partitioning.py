...
class PjitPartitioner(BasePjitPartitioner):
    ...
    def __init__(
        ...
        if logical_axis_rules is None:
            logical_axis_rules = standard_logical_axis_rules(activation_partitioning_dims=activation_partitioning_dims, parameter_partitioning_dims=parameter_partitioning_dims)
