...
import flax
#from flax import optimizer  # just used for transitional type definitions
...
OptimizerType = Union[ Optimizer]
OptimizerStateType = Union[ OptimizerState]
OptimizerDefType = Union[ OptimizerDef]
...
class OptaxStatePartitionRules:
    ...
    _RULES = {
        ...
        optax.ScaleByLionState: lambda state, params_axes: optax.ScaleByLionState(
